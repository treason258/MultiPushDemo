...
public class RomUtil {
    ...
    public static ROM getRom() {
        try {
            ...
            } else if (getSystemProperties(KEY_DISPLAY_ID, "").toLowerCase().contains(KEY_FLYME)) {
    ...
    private static Properties getPropertiesOld() {
        try {
            Properties properties = new Properties();
